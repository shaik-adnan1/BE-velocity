...
function History(props) {
  ...
  useEffect(() => {
    async function getAllTripAsPassenger() {
      ...
      setPassengerPageAmount(
        Math.ceil(result.data.history.length / cardPerPage)
      );
    }
        ...
        <div className="route__form ">
          ...
          {isPassenger ? (
            <>
              ...
              {renderHistory(
                historyAsPassenger
                  .slice(minPassengerPageValue, maxPassengerPageValue)
                  .reverse()
              )}
              <Pagination
                defaultCurrent={1}
            ...
            <>
              {renderHistory(
                historyAsDriver
                  .slice(minDriverPageValue, maxDriverPageValue)
                  .reverse()
              )}
              <Pagination
                defaultCurrent={1}
