...
function Settings(props) {
  ...
  const getOldUserData = async () => {
    ...
    const oldUserData = await axios.get(`/user/get/${props.userInfo.id}`, {
      headers: headers,
    });
  ...
  const getOldDriverData = async () => {
    ...
    console.log("oldDriverData", oldDriverData);
  ...
  const onFinishDriver = async (values) => {
    ...
    console.log(body);
    const edited = await axios.patch("/driver/edited", body, {
      headers: headers,
    });
    try {
      console.log("OK");
                    ...
                    <Col xs={20} sm={22} md={18} lg={14}>
                      ...
                      >
                        <Input
                          ...
                          placeholder={oldUserData.first_name}
                        />
                      </Form.Item>
                    </Col>
                  </Row>
                  ...
                  <Row justify="center">
                    <Col xs={20} sm={22} md={18} lg={14}>
                      ...
                      >
                        <Input
                          className="register__input"
                          placeholder={oldUserData.last_name}
                        />
                      </Form.Item>
                    </Col>
                  </Row>
                  ...
                  <Row justify="center">
                    <Col xs={20} sm={22} md={18} lg={14}>
                      ...
                      >
                        <Input
                          className="register__input"
                          placeholder={oldUserData.phone_number}
                        />
                      </Form.Item>
                    </Col>
                  </Row>
              ...
              >
                <Row justify="center">
                  <Col xs={20} sm={22} md={18} lg={14}>
                    ...
                    >
                      <Input
                        className="register__input"
                        placeholder={oldDriverData.driver_license}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Row justify="center">
                  <Col xs={20} sm={22} md={18} lg={14}>
                    ...
                    >
                      <Input
                        className="register__input"
                        placeholder={oldDriverData.car_model}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Row justify="center">
                  <Col xs={20} sm={22} md={18} lg={14}>
                    ...
                    >
                      <Input
                        className="register__input"
                        placeholder={oldDriverData.car_color}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Row justify="center">
                  <Col xs={20} sm={22} md={18} lg={14}>
                    ...
                    >
                      <Input
                        className="register__input"
                        placeholder={oldDriverData.seat}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Row justify="center">
                  <Col xs={20} sm={22} md={18} lg={14}>
                    ...
                    >
                      <Input
                        className="register__input"
                        placeholder={oldDriverData.bank_account}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Row justify="center">
                  <Col span={24} style={{ textAlign: "center" }}>
                    ...
                    >
                      <Checkbox>Data is up to date.</Checkbox>
                    </Form.Item>
                  </Col>
                </Row>
